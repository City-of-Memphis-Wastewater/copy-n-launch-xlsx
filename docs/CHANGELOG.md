...
- Still vendoring deps, rather than using requirements.txt (generated by uv export) then converting to typical flatpak python dep JSON using the flatpak builder tools python package.
